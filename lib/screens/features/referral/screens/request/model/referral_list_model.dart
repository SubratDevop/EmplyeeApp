...
ReferralListListModel referralListListModelFromJson(String str) =>
    ReferralListListModel.fromJson(json.decode(str));

String referralListListModelToJson(ReferralListListModel data) =>
...
class ReferralListListModel {
  ...
  factory ReferralListListModel.fromJson(Map<String, dynamic> json) =>
      ReferralListListModel(

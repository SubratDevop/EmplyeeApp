                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton2(
                        ...
                        // hint: const Text("All"),
                        value: controller.selectedReferralId.value == ""
                            ? null
                            : controller.selectedReferralId.value,
                        ...
                        items: controller.referralTypes.map(
                          (e) {
                            return DropdownMenuItem(
                              value: e.lookupId.toString(),
                              onTap: () => controller
                                  .selectedReferralName.value = e.lookupName!,
                              child: Text(
                  ...
                  Expanded(
                    child: controller.loadingReferral.value == true
                        ? const ShimmerLIst()
                        : controller.geReferralList.isEmpty
                            ? const Center(
                            ...
                            : ListView.separated(
                                ...
                                itemCount: controller.geReferralList.length,

...
import 'controller/department_referral_controller.dart';

class DepartmentReferralScreen extends StatelessWidget {
  const DepartmentReferralScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(DepartmentReferralController());
    return Obx(
      () => Scaffold(
                      ...
                      items: controller.bedNos.map(
                        (e) {
                          return DropdownMenuItem(
                            ...
                            onTap: () =>
                                controller.selectBedNo.value = e.bedNo!,
                            child: Text(
